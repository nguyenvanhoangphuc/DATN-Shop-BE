...
#         detail_address = self.request.query_params.get('detail_address', None)
...
#         type_search_detail_address = self.request.query_params.get('type_search_detail_address', None)
...
#                 raise ValidationError("Require email type search in ['exact', 'contains', 'startswith', 'endswith]")
#         if detail_address:
#             if type_search_detail_address == 'exact':
#                 queryset = queryset.filter(detail_address=detail_address)
#             elif type_search_detail_address == 'contains':
#                 queryset = queryset.filter(detail_address__icontains=detail_address)
#             elif type_search_detail_address == 'startswith':
#                 queryset = queryset.filter(detail_address__istartswith=detail_address)
#             elif type_search_detail_address == 'endswith':
#                 queryset = queryset.filter(detail_address__iendswith=detail_address)
#             else: 
#                 raise ValidationError("Require email type search in ['exact', 'contains', 'startswith', 'endswith]")
#         return queryset
...
#         if detail_address:
#             type_search_detail_address = self.request.query_params.get('type_search_detail_address', 'exact')
#             if type_search_detail_address == 'exact':
#                 filters |= Q(detail_address=detail_address)
#             elif type_search_detail_address == 'contains':
#                 filters |= Q(detail_address__icontains=detail_address)
#             elif type_search_detail_address == 'startswith':
#                 filters |= Q(detail_address__istartswith=detail_address)
#             elif type_search_detail_address == 'endswith':
#                 filters |= Q(detail_address__iendswith=detail_address)
#             else:
#                 raise ValidationError("Require detail address type search in ['exact', 'contains', 'startswith', 'endswith']")
